...
\item By Proposition 23 we can compute the factors in $K[[X]][Y]$ correct up to degree $K - \IntExpY \ge \alpha + \IntExpY$, and hence we con compute the $Y$-Puiseux expansions of the truncated polynomial correct up to degree $D = (K - \IntExpY) / e_i$.
